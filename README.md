...
| [`@nexusworld3d/engine-server`](./packages/engine-server) | `NexusRoomPlugin`, `registerResourceNode`, persistence + `createInMemory*` ([`PERSISTENCE`](./docs/PERSISTENCE.md), [`EXTENSION_APIS`](./docs/EXTENSION_APIS.md)) |
