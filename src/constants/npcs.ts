...
export const NPCS: Record<NPCId, NPCConfig> = {
  npc_grocer: {
    ...
    visual: {
      path: "/models/characters/men/men_01.glb",
      type: "glb",
      scale: 1,
    },
  },
  ...
  npc_doctor: {
    ...
    visual: {
      path: "/models/characters/women/women_01.glb",
      type: "glb",
      scale: 1,
    },
  },
  ...
  npc_super_grocer: {
    ...
    visual: {
      path: "/models/characters/men/men_04.glb",
      type: "glb",
      scale: 1,
    },
  },
  ...
  npc_trucker_boss: {
    id: "npc_trucker_boss",
    name: "Jefe de Camioneros",
    mapId: "exterior",
    zone: { position: { x: 60, y: 1, z: 60 }, radius: 3 },
    jobId: "trucker",
    visual: {
      path: "/models/characters/men/men_Idle.glb",
      type: "glb",
      scale: 1,
    },
  },
