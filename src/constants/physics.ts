...
export const PHYSICS_CONFIG = {
  ...
  ACCELERATION: 60, // Aceleración aumentada para respuesta rápida (antes 30)
  AIR_CONTROL: 5, // Fuerza de control en el aire (pequeña para ajustar trayectoria)
  DECELERATION: 50, // Frenado lateral (Aumentado para evitar deslizamiento)
  GRAVITY: -30, // Gravedad aumentada para caída más natural (antes: -19)
