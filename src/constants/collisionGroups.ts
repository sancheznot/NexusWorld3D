...
export const CollisionMasks = {
   ...
   * Usamos ~TrimeshColliders para evitar colisiones con objetos internos
   */
 ...
 */
export function debugCollisionInfo(
