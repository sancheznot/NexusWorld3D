...
> = {
  ...
  seed_lettuce: {
    ...
    maxStack: 99,
    icon: '🌱',
    visual: { path: '/models/terrain/environment/Plant_02.glb', type: 'gltf', scale: 0.25 },
  },
  food_lettuce: {
    name: 'Lechuga',
    type: 'consumable',
    ...
    maxStack: 99,
    icon: '🥬',
    visual: { path: '/models/terrain/environment/Plant_02.glb', type: 'gltf', scale: 0.45 },
    effects: { health: 8 }
  },
  food_salad: {
    name: 'Ensalada',
  ...
  exterior: [
    ...
    },
    {
      ...
      item: {
        ...
        weight: 2.4,
        name: "Pico",
        description: "Para picar rocas (click con el ítem en la hotbar)",
        type: "weapon" as ItemType,
        rarity: "common" as ItemRarity,
        icon: "⛏️",
      },
    ...
    {
      id: "spawn_stone_raw_plot_zone",
      mapId: "exterior",
      position: { x: 52, y: 0.6, z: -11 },
      respawnSec: 30,
      item: {
        ...
        weight: 1.5,
        name: "Piedra bruta",
        description: "Para el kit de cabaña",
        type: "misc" as ItemType,
        rarity: "common" as ItemRarity,
        icon: "🪨",
      },
